...
Friend Module Helpers
    ...
    Public Function MiddlePoint(TargetText As String, TargetFont As Font, Rect As Rectangle) As Point
        ...
        If Enabled Then
            ...
            Select Case State
                Case MouseState.None
                    Gradient = New LinearGradientBrush(New Rectangle(0, 0, Width - 1, Height - 1), ColorFromHex("#606060"), ColorFromHex("#4E4E4E"), LinearGradientMode.Vertical)

                Case MouseState.Over
                    Gradient = New LinearGradientBrush(New Rectangle(0, 0, Width - 1, Height - 1), ColorFromHex("#6A6A6A"), ColorFromHex("#585858"), LinearGradientMode.Vertical)

                Case MouseState.Down
                    Gradient = New LinearGradientBrush(New Rectangle(0, 0, Width - 1, Height - 1), ColorFromHex("#565656"), ColorFromHex("#444444"), LinearGradientMode.Vertical)

            End Select

            G.FillPath(Gradient, RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), 3))

            Using Border As New Pen(ColorFromHex("#323232"))
                G.DrawPath(Border, RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), 3))
            End Using
            ...
            Select Case State
                ...
                Case MouseState.None
                    ...
                    Using TopLine As New Pen(ColorFromHex("#737373"))
                        G.DrawLine(TopLine, 4, 1, Width - 4, 1)
                    End Using

                Case MouseState.Over

                    Using TopLine As New Pen(ColorFromHex("#7D7D7D"))
                        G.DrawLine(TopLine, 4, 1, Width - 4, 1)
                    End Using

                Case MouseState.Down

                    Using TopLine As New Pen(ColorFromHex("#696969"))
                        G.DrawLine(TopLine, 4, 1, Width - 4, 1)
                    End Using

            End Select

            Using TextBrush As New SolidBrush(ColorFromHex("#F5F5F5")), TextFont As New Font("Segoe UI", 9)
                G.DrawString(Text, TextFont, TextBrush, MiddlePoint(Text, TextFont, New Rectangle(0, 0, Width + 2, Height)))
            End Using

        Else

            Gradient = New LinearGradientBrush(New Rectangle(0, 0, Width - 1, Height - 1), ColorFromHex("#4C4C4C"), ColorFromHex("#3A3A3A"), LinearGradientMode.Vertical)
            ...
            Using TopLine As New Pen(ColorFromHex("#5F5F5F"))
                G.DrawLine(TopLine, 4, 1, Width - 4, 1)
            End Using

            Using TextBrush As New SolidBrush(ColorFromHex("#818181")), TextFont As New Font("Segoe UI", 9)
                G.DrawString(Text, TextFont, TextBrush, MiddlePoint(Text, TextFont, New Rectangle(0, 0, Width + 2, Height)))
            End Using
...
Public Class BoosterHeader
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Using Line As New Pen(ColorFromHex("#5C5C5C"))
            G.DrawLine(Line, 0, 6, Width - 1, 6)
        End Using

        Using TextBrush As New SolidBrush(ColorFromHex("#D4D4D4")), TextFont As New Font("Segoe UI", 10), ParentFill As New SolidBrush(Parent.BackColor)
...
Public Class BoosterToolTip
    ...
    Private Sub OnDraw(sender As Object, e As DrawToolTipEventArgs)
        ...
        G.Clear(ColorFromHex("#242424"))

        Using Border As New Pen(ColorFromHex("#343434"))
        ...
        If ToolTipIcon = ToolTipIcon.None Then
            ...
            Using TextFont As New Font("Segoe UI", 9), TextBrush As New SolidBrush(ColorFromHex("#B6B6B6"))
        ...
        Else
            ...
            Select Case ToolTipIcon
                ...
                Case ToolTipIcon.Info
                    ...
                    Using TextFont As New Font("Segoe UI", 9, FontStyle.Bold), TextBrush As New SolidBrush(ColorFromHex("#7FD88B"))
                        G.DrawString("Information", TextFont, TextBrush, New PointF(e.Bounds.X + 4, e.Bounds.Y + 2))
                    End Using

                Case ToolTipIcon.Warning

                    Using TextFont As New Font("Segoe UI", 9, FontStyle.Bold), TextBrush As New SolidBrush(ColorFromHex("#D8C67F"))
                        G.DrawString("Warning", TextFont, TextBrush, New PointF(e.Bounds.X + 4, e.Bounds.Y + 2))
                    End Using

                Case ToolTipIcon.Error

                    Using TextFont As New Font("Segoe UI", 9, FontStyle.Bold), TextBrush As New SolidBrush(ColorFromHex("#D87F7F"))
...
Public Class BoosterTextBox
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Enabled Then
            ...
            T.BackColor = ColorFromHex("#242424")
            ...
            Select Case State
                ...
                Case Else
                    ...
                    Using Border As New Pen(ColorFromHex("#5C5C5C"))
                        G.DrawRectangle(Border, New Rectangle(0, 0, Width - 1, Height - 1))
                    End Using
        ...
        Else
            ...
            T.BackColor = ColorFromHex("#282828")

            Using Border As New Pen(ColorFromHex("#484848"))
                G.DrawRectangle(Border, New Rectangle(0, 0, Width - 1, Height - 1))
            End Using
...
Public Class BoosterComboBox
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Enabled Then
            ...
            Using Fill As New SolidBrush(ColorFromHex("#242424"))
            ...
            Using ArrowFont As New Font("Marlett", 12), ArrowBrush As New SolidBrush(ColorFromHex("#909090"))
            ...
            If Not IsNothing(Items) Then
                ...
                If Not SelectedIndex = -1 Then
                    ...
                    Using TextBrush As New SolidBrush(ColorFromHex("#B6B6B6")), TextFont As New Font("Segoe UI", 9)
        ...
        Else
            ...
            Using Fill As New SolidBrush(ColorFromHex("#282828")), Border As New Pen(ColorFromHex("#484848"))
                G.FillRectangle(Fill, New Rectangle(0, 0, Width - 1, Height - 1))
                G.DrawRectangle(Border, New Rectangle(0, 0, Width - 1, Height - 1))
            End Using

            Using ArrowFont As New Font("Marlett", 12), ArrowBrush As New SolidBrush(ColorFromHex("#707070"))
                G.DrawString("6", ArrowFont, ArrowBrush, New Point(Width - 20, 5))
            End Using
    ...
    Protected Overrides Sub OnDrawItem(e As DrawItemEventArgs)
        ...
        Using Back As New SolidBrush(ColorFromHex("#242424"))
        ...
        Using ItemsFont As New Font("Segoe UI", 9), Border As New Pen(ColorFromHex("#D0D5D9"))
            ...
            If (e.State And DrawItemState.Selected) = DrawItemState.Selected Then
                ...
                Using HoverItemBrush As New SolidBrush(ColorFromHex("#F5F5F5"))
                    G.DrawString(ItemString, New Font("Segoe UI", 9), HoverItemBrush, New Point(Rect.X + 5, Rect.Y + 1))
                End Using

            Else

                Using DefaultItemBrush As New SolidBrush(ColorFromHex("#C0C0C0"))
...
Public Class BoosterCheckBox
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Enabled Then
            ...
            Using Fill As New SolidBrush(ColorFromHex("#242424")), Border As New Pen(ColorFromHex("#5C5C5C"))
        ...
        Else
            ...
            Using CheckFont As New Font("Marlett", 12), CheckBrush As New SolidBrush(ColorFromHex("#707070"))
                G.DrawString("b", CheckFont, CheckBrush, New Point(-2, 1))
            End Using

            Using Fill As New SolidBrush(ColorFromHex("#282828"))
                G.SmoothingMode = SmoothingMode.None
                G.FillRectangle(Fill, OverFillRect)
            End Using
...
Public Class BoosterTabControl
    ...
    Protected Overrides Sub CreateHandle()
        For Each Tab As TabPage In TabPages
            Tab.BackColor = ColorFromHex("#424242")
            Tab.ForeColor = ColorFromHex("#B6B6B6")
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        G.Clear(ColorFromHex("#333333"))

        Using Border As New Pen(ColorFromHex("#292929"))
            G.SmoothingMode = SmoothingMode.None
        ...
        For I As Integer = 0 To TabPages.Count - 1
            ...
            If SelectedIndex = I Then
                ...
                Using Selection As New SolidBrush(ColorFromHex("#424242"))
                    G.FillRectangle(Selection, New Rectangle(MainRect.X - 6, MainRect.Y + 2, MainRect.Width + 8, MainRect.Height - 1))
                End Using

                Using SelectionLeft As New SolidBrush(ColorFromHex("#F63333"))
                    G.FillRectangle(SelectionLeft, New Rectangle(MainRect.X - 2, MainRect.Y + 2, 3, MainRect.Height - 1))
                End Using

                Using TextBrush As New SolidBrush(ColorFromHex("#F5F5F5")), TextFont As New Font("Segoe UI", 10)
                    G.DrawString(TabPages(I).Text, TextFont, TextBrush, New Point(MainRect.X + 25, MainRect.Y + 11))
                End Using

            Else

                Using TextBrush As New SolidBrush(ColorFromHex("#C0C0C0")), TextFont As New Font("Segoe UI", 10)
                    G.DrawString(TabPages(I).Text, TextFont, TextBrush, New Point(MainRect.X + 25, MainRect.Y + 11))
                End Using
            ...
            If Hovering Then
                ...
                Using Selection As New SolidBrush(ColorFromHex("#383838"))
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Enabled Then
            ...
            If Checked Then
                ...
                Using CheckBrush As New SolidBrush(ColorFromHex("#909090"))
        ...
        Else
            ...
            If Checked Then
                ...
                Using CheckBrush As New SolidBrush(ColorFromHex("#707070"))
                    G.FillEllipse(CheckBrush, EllipseRect)
                End Using
...
Public Class BoosterNumericUpDown
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Enabled Then
            ...
            Using TextBrush As New SolidBrush(ColorFromHex("#B6B6B6"))
                G.DrawString(Value & AfterValue, TextFont, TextBrush, TextPoint)
            End Using

            Using ArrowFont As New Font("Marlett", 10), ArrowBrush As New SolidBrush(ColorFromHex("#909090"))
        ...
        Else
            ...
            Using TextBrush As New SolidBrush(ColorFromHex("#818181"))
                G.DrawString(Value & AfterValue, TextFont, TextBrush, TextPoint)
            End Using

            Using ArrowFont As New Font("Marlett", 10), ArrowBrush As New SolidBrush(ColorFromHex("#707070"))
                G.DrawString("5", ArrowFont, ArrowBrush, New Point(Width - 18, 2))
                G.DrawString("6", ArrowFont, ArrowBrush, New Point(Width - 18, 10))
            End Using
